...
CREATE TABLE ACTION (
  ...
  description TEXT,
  idmesure TEXT,
  PRIMARY KEY (idR, noetape, nose, noac)
);
...
ALTER TABLE CUVEE ADD FOREIGN KEY (idR) REFERENCES RECETTE (idR);
...
ALTER TABLE ETAPE ADD FOREIGN KEY (idR) REFERENCES RECETTE (idR);
ALTER TABLE ETAPECU ADD FOREIGN KEY (idR, noetape) REFERENCES ETAPE (idR, noetape);
...
ALTER TABLE SOUSETAPE ADD FOREIGN KEY (idR, noetape) REFERENCES ETAPE (idR, noetape);
ALTER TABLE SOUSETAPECU ADD FOREIGN KEY (idR, noetape, nose) REFERENCES SOUSETAPE (idR, noetape, nose);
...
ALTER TABLE ACTION ADD FOREIGN KEY (idR, noetape, nose) REFERENCES SOUSETAPE (idR, noetape, nose);
ALTER TABLE ACTIONCU ADD FOREIGN KEY (idR, noetape, nose, noac) REFERENCES ACTION (idR, noetape, nose, noac);
